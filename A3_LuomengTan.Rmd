...
Please have all the files and directory in my [A3 directory](https://github.com/bcb420-2022/Luomeng_Tan/tree/main/A3) in GitHub repo in the same directory of the Rmd file in order to complie the Rmd file. The file strcture should look like below:
...
![Figure 1: Cytoscape settings for the intial enrichment map](./figures/EM_initial.png)


![Figure 2: Enrichment Map for my GSEA results](./figures/em.png)
...
![Figure 3: Result after annotation using AutoAnnotate](./figures/annotate.png)

## Publication ready figure 
I made the publication ready figure by checking the "Publication-Ready" in EnrichmentMap panel.

![Figure 4: Publication ready figure for our network](./figures/pub_ready.png)

![Figure 5: Legend of the enrichment map](./figures/legend.png)
...
![Figure 6: Failed theme network plot](./figures/theme.png)
...
![Figure 7: Overlapped gene sets from nutraceutical drugs](./figures/overlap.png)
...
![Figure 8: Enrichment Map with the nutraceutical gene sets](./figures/post.png)
